      ...
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-5">
        <div className="flex flex-col gap-5 lg:gap-10">
          <p className=" text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-medium">
            Infinite Task <br className="lg:flex hidden" />
          ...
          >
            ...
            membantu <br className="lg:flex hidden" />
            pengguna untuk membuat, mengelola, dan memonitor project atau tugas
            dengan <br className="lg:flex hidden" />
            lebih efisien.
          </p>
          <button
            className="btn btn-sm lg:btn-lg bg-[#816797] text-white rounded-full border-[#5F4C6F] w-40 lg:w-44 capitalize"
            style={{ marginTop: "-15px", height: "36px" }}
          >
            Get Started
          </button>
        </div>
